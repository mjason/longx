...
export type ThreadComponents = {
  ...
  /** Longx: the composer's rail — the access mode (left of send) and the model (right) */
...
// Longx: no edit — the codex runtime has no onEdit (a turn is history)
const UserActionBar: FC = () => null;
