...
export const t = {
  ...
  mobilePage: {
    pairTitle: "配对手机",
    pairHint: "在 Longx 手机 app 里填这里的地址，再输入配对码。配对码十分钟内有效，用一次就作废；手机拿到的是一枚设备令牌，之后所有请求都用它。",
    address: "服务器地址",
    code: "配对码",
    expires: "十分钟内有效，用一次就作废",
    generate: "生成配对码",
    regenerate: "重新生成",
    devicesTitle: "已配对的设备",
    none: "还没有配对的手机",
    platforms: { android: "Android", ios: "iOS", other: "其他" } as Record<string, string>,
    seen: (when: string) => `上次使用 ${when}`,
    neverSeen: "还没用过",
    revoke: "解除配对",
    revokeTitle: (name: string) => `解除 ${name} 的配对？`,
    revokeHint: "这台手机的令牌立刻失效，要再用得重新配对。",
    revokeConfirm: "解除配对",
  },
  processesPage: {
