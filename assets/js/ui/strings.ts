...
export const t = {
  ...
  knowledgePage: {
    hint: "原生内核的知识：markdown 文件，front matter 里 always: true 的每轮都进 prompt，其余只进一行索引，agent 按需读。这里是你自己的全局知识（对所有项目生效，每次保存一个 git 提交）；项目的知识在仓库的 .longx/knowledge/ 里。Longx 出厂的那批只读。",
    global: "我的全局知识",
    shipped: "Longx 出厂",
    ...
    create: "新建",
    newPath: "文件名",
    newPathHint: "只要名字，.md 会自动加上；可以带子目录，如 tools/deploy",
